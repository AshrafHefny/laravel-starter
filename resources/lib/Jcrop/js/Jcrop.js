...
(function ($) {
    ...
    $.extend(CanvasStage, {
        isSupported: function (el, o) {
            if ($.Jcrop.supportsCanvas && (el.tagName == 'IMG'))
                return true;
        },
        priority: 60,
        create: function (el, options, callback) {
    ...
    $.extend(ShadeFilter.prototype, {
        ...
        setColor: function (color, instant) {
            ...
            $.each(t.shades, function (u, i) {
                if (!t.fade || instant || !colorfade)
                    i.css('backgroundColor', color);
                else
                    i.animate({backgroundColor: color}, {queue: false, duration: t.fadeSpeed, easing: t.fadeEasing});
            });
            return t;
        },
        setOpacity: function (opacity, instant) {
            ...
            $.each(t.shades, function (u, i) {
                if (!t.fade || instant)
                    ...
                    i.animate({opacity: opacity}, {queue: false, duration: t.fadeSpeed, easing: t.fadeEasing});
            });
            return t;
        },
    ...
    $.extend(Selection, {
        ...
        prototype: {
            ...
            allowSelect: function (v) {
                ...
                if (v && this.canSelect)
                    this.frame.attr('disabled', false);
                else
            ...
            allowDrag: function (v) {
                ...
                if (v && t.canDrag)
                    t.element.removeClass(o.css_nodrag);
                else
                    t.element.addClass(o.css_nodrag);
            ...
            allowResize: function (v) {
                ...
                if (v && t.canResize)
                    t.element.removeClass(o.css_noresize);
                else
                    t.element.addClass(o.css_noresize);
    ...
    $.extend(StageDrag.prototype, {
        ...
        start: function (e) {
            ...
            if (!c.opt.allowSelect)
                return;

            // Also do nothing if we can't draw any more selections
            if (c.opt.multi && c.opt.multiMax && (c.ui.multi.length >= c.opt.multiMax))
                return false;
        ...
        prototype: {
            ...
            show: function () {
                ...
                if (!this.fading)
                    ...
                    this.element.stop().animate({opacity: 1}, {duration: 80, queue: false});
            },
            hide: function () {
                var t = this;
                if (!t.fading)
            ...
            initEvents: function () {
                ...
                t.core.container.on('croprotstart croprotend cropimage cropstart cropmove cropend', function (e, s, c) {
                    if (t.selectionTarget && (t.selectionTarget !== e.target))
                        return false;
