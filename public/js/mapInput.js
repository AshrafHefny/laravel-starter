...
//open onclick
    ...
    for (let i = 0; i < locationInputs.length; i++) {
        ...
        const latitude = parseFloat(document.getElementById(fieldKey + "-latitude").value) || 30.06263;
        const longitude = parseFloat(document.getElementById(fieldKey + "-longitude").value) ||  31.24967;
        ...
        map.addListener('click', function (e) {
            ...
            placeMarker(marker, e.latLng, map);
        });
